...
| What to test | How |
|---|---|
| Hearth & Hird test panel | Host/single-player: `hnh_test enable`, then press `F7` to spawn, select, equip and command test units. See [the multiplayer test guide](docs/MULTIPLAYER_TESTING.md) |
